/**
	...
	`CFFGLPluginInfo` that Stencil.cpp registers at static-initialisation time.
	...
	binary: which build it is.
		...
		strings Stencil.bundle/Contents/MacOS/Stencil | grep stencil
*/

extern "C" const char* StencilBuildStamp()
{
	return "stencil " STENCIL_VERSION " built " __DATE__ " " __TIME__;
}
