...
/**
    ...
    **The jump flood stores integer pixel coordinates**, and the component
    labels it reads are R32UI. Its buffers are RGBA16UI, and `FFGLFBO::GenerateColorTexture()` allocates every texture
...
public:
	...
	/// format that goes with the internal format (the CPU half of the bridging
	/// hands its labels and its cut masks back this way).
